    ...
    <div className="relative min-h-screen overflow-x-hidden bg-[#050816] text-white font-sans">
      ...
      <nav className="sticky top-0 z-50 backdrop-blur-xl bg-black/20 border-b border-white/10">
        <div className="max-w-7xl mx-auto flex flex-wrap justify-between items-center px-4 md:px-8 py-5">
          <div className="flex items-center gap-3">
            <img src="/logo.png" alt="Aivexa Logo" className="w-8 h-8 md:w-12 md:h-12 object-contain" />
      ...
      >
        ...
        <motion.div
          ...
          className="mb-8 inline-flex items-center gap-2 bg-cyan-500/10 border border-cyan-500/40 rounded-full px-5 py-2 text-sm text-cyan-300 font-medium backdrop-blur-md"
        >
        ...
        {/* Subheading — fixed AIVEXA capitalisation */}
        ...
        {/* ✅ MERGED DEMO SHOWCASE — Single unified section */}
        <section
          id="demo-showcase"
          className="relative px-8 pt-24 md:pt-52 pb-14 md:pb-28 max-w-7xl mx-auto w-full"
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 mb-16">
            ...
            >
              ...
              />
              <div className="p-8">
                <p className="text-cyan-400 font-semibold mb-3">DEMO 1</p>
                <h3 className="text-2xl font-bold mb-4">WhatsApp AI Chatbot</h3>
            ...
            >
              ...
              />
              <div className="p-8">
                <p className="text-cyan-400 font-semibold mb-3">DEMO 2</p>
                <h3 className="text-2xl font-bold mb-4">AI Lead Capture Workflow</h3>
                <p className="text-gray-300 leading-relaxed">
            ...
            >
              ...
              />
              <div className="p-8">
                <p className="text-cyan-400 font-semibold mb-3">DEMO 3</p>
                <h3 className="text-2xl font-bold mb-4">Appointment Booking Automation</h3>
                <p className="text-gray-300 leading-relaxed">
          ...
          {/* ✅ WORKFLOW DEMONSTRATIONS (merged from case-studies) */}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl hover:border-cyan-400/40 hover:scale-105 transition duration-300">
              ...
              <h3 className="text-2xl font-bold mb-4">AI Customer Support Bot</h3>
              <p className="text-gray-400 leading-relaxed mb-6">
                Automated website chatbot that instantly answers FAQs,
                qualifies leads, and books consultations 24/7.
              </p>
              <div className="space-y-3 text-sm text-gray-300">
                <div className="flex items-center gap-2">✅ Instant lead qualification</div>
                <div className="flex items-center gap-2">✅ WhatsApp integration</div>
                <div className="flex items-center gap-2">✅ CRM synchronization</div>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl hover:border-purple-400/40 hover:scale-105 transition duration-300">
              ...
              <h3 className="text-2xl font-bold mb-4">Automated Quote Workflow</h3>
              <p className="text-gray-400 leading-relaxed mb-6">
                Smart workflow that collects customer requirements,
                generates quotations, and sends automated follow-ups.
              </p>
              <div className="space-y-3 text-sm text-gray-300">
                <div className="flex items-center gap-2">✅ Instant quote requests</div>
                <div className="flex items-center gap-2">✅ Automated email replies</div>
                <div className="flex items-center gap-2">✅ Lead tracking dashboard</div>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-3xl p-8 backdrop-blur-xl hover:border-blue-400/40 hover:scale-105 transition duration-300">
              ...
              <h3 className="text-2xl font-bold mb-4">Social Media AI Assistant</h3>
              <p className="text-gray-400 leading-relaxed mb-6">
                AI-powered assistant that manages inquiries,
                captures leads, and automates responses from social media.
              </p>
              <div className="space-y-3 text-sm text-gray-300">
                <div className="flex items-center gap-2">✅ Facebook automation</div>
                <div className="flex items-center gap-2">✅ Instagram lead capture</div>
                <div className="flex items-center gap-2">✅ CRM integrations</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-4xl font-black text-cyan-400 mb-3">24/7</h3>
              <h4 className="text-2xl font-bold mb-4">Always Running</h4>
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-purple-500/20 flex items-center justify-center text-3xl mb-6">🤖</div>
              <h3 className="text-4xl font-black text-purple-400 mb-3">AI</h3>
            ...
            {/* ✅ Fixed off-brand pink → cyan accent */}
            <motion.div
              whileHover={{ y: -10, scale: 1.03 }}
              transition={{ duration: 0.3 }}
              className="bg-white/5 border border-cyan-500/20 rounded-3xl p-8 backdrop-blur-xl shadow-[0_0_40px_rgba(0,255,255,0.08)] hover:border-cyan-400"
            >
              <div className="w-16 h-16 rounded-2xl bg-cyan-500/20 flex items-center justify-center text-3xl mb-6">🚀</div>
              <h3 className="text-4xl font-black text-cyan-400 mb-3">Custom</h3>
              <h4 className="text-2xl font-bold mb-4">Tailored Solutions</h4>
              <p className="text-gray-400 leading-relaxed">
      ...
      <section id="services" className="relative py-16 md:py-28 px-6 bg-[#050816] text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-300 mb-6">
                Automate lead capture, notifications, follow-ups and lead tracking so no opportunity gets missed.
              </p>
              ...
              <div className="border-t border-white/10 mt-6 pt-6 text-gray-300">
                Monthly Retainer: <strong>R1,250/month</strong>
              </div>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-300 mb-6">
                AI chatbot that answers questions, qualifies leads and routes opportunities automatically.
              </p>
              <ul className="space-y-3 text-gray-300 mb-8">
      ...
      <section className="relative px-8 py-32 bg-gradient-to-b from-black/10 to-black/30 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <div className="absolute top-0 right-0 text-[120px] font-black text-white/5 leading-none">01</div>
              <div className="w-16 h-16 rounded-2xl bg-cyan-500/20 flex items-center justify-center text-3xl mb-8">📞</div>
              <h3 className="text-3xl font-bold mb-5">Consultation</h3>
            ...
            >
              <div className="absolute top-0 right-0 text-[120px] font-black text-white/5 leading-none">02</div>
              <div className="w-16 h-16 rounded-2xl bg-purple-500/20 flex items-center justify-center text-3xl mb-8">⚙️</div>
              <h3 className="text-3xl font-bold mb-5">System Build</h3>
              <p className="text-gray-400 leading-relaxed text-lg">
            ...
            <motion.div
              ...
              className="relative bg-white/5 border border-cyan-500/20 rounded-3xl p-10 backdrop-blur-xl overflow-hidden hover:border-cyan-400 shadow-[0_0_50px_rgba(0,255,255,0.08)]"
            >
              <div className="absolute top-0 right-0 text-[120px] font-black text-white/5 leading-none">03</div>
              <div className="w-16 h-16 rounded-2xl bg-cyan-500/20 flex items-center justify-center text-3xl mb-8">🚀</div>
              <h3 className="text-3xl font-bold mb-5">Launch & Scale</h3>
              <p className="text-gray-400 leading-relaxed text-lg">
      ...
      <section id="about" className="relative px-8 py-24 overflow-hidden">
          ...
          >
            ...
            <div className="flex-shrink-0">
              <div className="relative w-56 h-56 md:w-72 md:h-72">
                <div className="absolute inset-0 rounded-full bg-gradient-to-br from-cyan-400 to-blue-600 blur-2xl opacity-30" />
                <img
                  src="/founder.png"
            ...
            <div className="flex-1 text-left">
              ...
              <p className="text-cyan-400 font-semibold mb-6 tracking-wide">
                Founder & CEO — AIVEXA Solutions
              </p>

              <div className="space-y-4 text-gray-300 leading-relaxed text-lg">
                <p>
                  My name is Devan, and I founded AIVEXA from a simple but powerful
                  realisation — most businesses are drowning in manual work they don't have to do.
                </p>
                <p>
                  Before AIVEXA, I spent years in the office automation industry, working closely
                  with businesses across various operations. I watched talented teams waste hours
                  every day on repetitive tasks, missed leads, and slow communication processes
                  that technology could solve in minutes.
                </p>
                <p>
                  I started AIVEXA because I knew I had more to offer. Not just to the businesses
                  I work with — but to myself. I believed there was a better way to create real,
                  measurable impact beyond the limits of a traditional career.
                </p>
                <p>
                  AIVEXA was built on one core belief — that businesses deserve smarter systems.
                  Systems that work around the clock, reduce operational drag, and free up the
                  people inside those businesses to focus on what truly matters.
                </p>
                <p className="text-cyan-300 font-medium">
                  Based in Port Elizabeth, South Africa — AIVEXA is built for businesses that are
      ...
      {/* FAQ */}
      <section id="faq" className="relative px-8 py-12 md:py-28">
            ...
            {[
              {
                ...
                a: "Almost any business can automate repetitive tasks, lead generation, customer support, and workflows. We work especially well with admin-heavy businesses, service providers, and companies that handle high volumes of customer communication.",
              },
              {
                q: "Do you build custom AI systems?",
                a: "Yes. Every automation solution is designed around your specific business requirements, goals, and existing tools.",
              },
              {
                q: "Can you automate WhatsApp?",
                a: "Yes. We build WhatsApp automation systems for communication, bookings, lead management, and customer support.",
              },
              {
                q: "How long does setup take?",
                a: "Most automation systems are built and live within 7–14 business days depending on complexity. We'll give you a clear timeline during your free consultation.",
              },
              {
                q: "What tools do you use?",
                a: "We primarily use Make.com, Zapier, GoHighLevel, and WhatsApp APIs to build automation systems. We always recommend the best tool for your specific needs.",
              },
              {
                q: "Do I need technical knowledge to use the systems?",
                a: "Not at all. We build, set up, and hand over everything fully operational. We also provide guidance so you can manage it confidently without any technical background.",
              },
              {
                q: "Do you offer ongoing support after setup?",
                a: "Yes. We offer monthly retainer packages that include system monitoring, updates, optimisation, and ongoing support so your automation keeps running at its best.",
              },
              {
                q: "How much can automation save my business?",
                a: "Most clients reclaim 10–20+ hours per week in admin time alone. Beyond time, faster lead response and automated follow-ups directly improve conversion rates and revenue.",
              },
            ].map((faq, index) => (
              <div
                key={index}
      ...
      {/* CONTACT */}
      <section id="contact" className="relative px-8 py-12 md:py-28 bg-black/20">
      ...
      <footer className="relative border-t border-white/10 bg-black/30 backdrop-blur-xl mt-32">
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div>
              ...
              <div className="flex gap-4 mt-6">
                <a href="https://linkedin.com/company/officialaivexa" target="_blank" rel="noopener noreferrer"
                ...
                <a href="https://facebook.com/officialaivexa" target="_blank" rel="noopener noreferrer"
                ...
                <a href="https://instagram.com/officialaivexa" target="_blank" rel="noopener noreferrer"
                  className="bg-white/5 hover:bg-cyan-500/20 border border-white/10 hover:border-cyan-400 transition-all duration-300 p-4 rounded-2xl">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://youtube.com/@officialaivexa" target="_blank" rel="noopener noreferrer"
                  className="bg-white/5 hover:bg-cyan-500/20 border border-white/10 hover:border-cyan-400 transition-all duration-300 p-4 rounded-2xl">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <div className="flex flex-col gap-4 text-gray-400">
                <a href="mailto:info@aivexasolutions.com" className="hover:text-cyan-400 transition">
                  info@aivexasolutions.com
                </a>
                <a href="https://linkedin.com/company/officialaivexa" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition">
          ...
          <div className="border-t border-white/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">© 2026 AIVEXA. All rights reserved.</p>
        ...
        <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50 w-[95%] max-w-2xl bg-[#151030] border border-cyan-500/30 shadow-2xl rounded-2xl p-6 backdrop-blur-lg">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-3">
              <button onClick={declineCookies} className="px-4 py-2 rounded-xl border border-white/10 text-gray-300 hover:bg-white/10 transition">
                Decline
              </button>
              <button onClick={acceptCookies} className="px-4 py-2 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-black font-semibold transition">
                Accept
              </button>
            </div>
          </div>
